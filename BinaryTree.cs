...
namespace OOP_2sem
{
    ...
    {
        public delegate void StateHandler(string message,BinaryTreeNode<T> node);
        ...
        {
            Notify?.Invoke("Trying to add Node ",node);
        ...
        public static void InOrderTraversal(BinaryTreeNode<T> root)
        {
            ...
            Console.WriteLine("In order traversal in node:{0}",root.Data);
